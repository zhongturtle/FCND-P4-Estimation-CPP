...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  Quaternion<float> qt_tmp = Quaternion<float>::FromEuler123_RPY(rollEst, pitchEst, ekfState(6));
	//qt_bar = dq * qt
	Quaternion<float> qt_bar = qt_tmp.IntegrateBodyRate(gyro, dtIMU);
...
void QuadEstimatorEKF::Predict(float dt, V3F accel, V3F gyro)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    ...
    MatrixXf p_covariance = gPrime;
    p_covariance.transposeInPlace();

    ekfCov = (gPrime * ( ekfCov * p_covariance ) )+ Q;
